      ...
      {skills.map((skill, i) => (
        <div
          ...
          className={cn(
            ...
            i % 3 == 0 && "dark:hover:bg-orange-950 dark:hover:text-orange-400 hover:bg-orange-200 hover:text-orange-700",
            i % 5 == 0 && "dark:hover:bg-sky-950 dark:hover:text-sky-400 hover:bg-sky-200 hover:text-sky-700",
